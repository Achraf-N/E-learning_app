      ...
      <div className="mt-24 rtl:md:my-40 rtl:my-20">
        <div className="container">
          <div className="flex flex-col-reverse items-center lg:flex-row">
            <div className="mt-8">
              <LazyLoadImage
                src="https://ihozhkncmbnfrodpmrwo.supabase.co/storage/v1/object/public/images/Best.jpg"
                alt="E-Learning"
              />
            </div>
            <div className="w-full ml-0 ltr:lg:ml-24 rtl:lg:mr-24 rtl:lg:w-8/12 ltr:lg:w-3/6">
              ...
              <div className="mt-4">
                <div className="flex items-center">
                  <img
                    src="https://ihozhkncmbnfrodpmrwo.supabase.co/storage/v1/object/public/images/iconOne.png"
                    alt="Learn With Videos"
                  />
                  <p className="ltr:ml-2 rtl:mr-2">{t('learn_with_videos')}</p>
                </div>
                <div className="my-4 items-center flex">
                  <img
                    src="https://ihozhkncmbnfrodpmrwo.supabase.co/storage/v1/object/public/images/iconTwo.png"
                    alt="Creative Study Pattern"
                  />
                  <p className="ltr:ml-2 rtl:mr-2">{t('creative_study')}</p>
                </div>
                <div className=" flex items-center">
                  <img
                    src="https://ihozhkncmbnfrodpmrwo.supabase.co/storage/v1/object/public/images/iconThree.png"
                    alt="Provided With Examples"
                  />
